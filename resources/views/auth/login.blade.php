        ...
        <div
            ...
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                    New here? <a href="{{ route('register') }}"
                        class="font-medium text-primary-600 hover:text-primary-500">Start your free trial</a>
                </p>
            </div>
            ...
            <div class="relative">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-2 bg-white dark:bg-dark-card text-gray-500">Or sign in with email</span>
                </div>
            </div>
